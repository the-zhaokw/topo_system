...
const getActionText = (action) => {
  const texts = {
    ...
    'create_project_member': '添加项目成员',
    'create_user': '创建用户',
    'create_work_log': '创建工作日志',
    'create_leave_application': '创建请假申请',
    'create_overtime_application': '创建加班申请',
    'create_risk': '创建风险',
    'create_requirement_document': '创建需求文档',
    'create_requirement_item': '创建需求条目',
    'create_requirement_comment': '创建需求评论',
    'create_requirement_link': '创建需求关联',
    'create_requirement_version': '创建需求版本',
    'create_knowledge_article': '创建知识文章',
    'create_knowledge_category': '创建知识分类',
    'create_knowledge_comment': '创建知识评论',
    'create_personal_task': '创建个人任务',
    'create_personal_template': '创建个人模板',
    'create_personal_review': '创建个人复盘',
    'create_test_suite': '创建测试套件',
    'create_test_case': '创建测试用例',
    'create_test_execution': '创建测试执行',
    'create_shift_schedule': '创建班次安排',
    ...
    'update_risk': '更新风险',
    'update_requirement_document': '更新需求文档',
    'update_requirement_item': '更新需求条目',
    'update_knowledge_article': '更新知识文章',
    'update_knowledge_category': '更新知识分类',
    'update_personal_task': '更新个人任务',
    'update_personal_template': '更新个人模板',
    'update_personal_review': '更新个人复盘',
    'update_test_suite': '更新测试套件',
    'update_test_case': '更新测试用例',
    'delete': '删除',
    'delete_project': '删除项目',
    'delete_project_member': '移除项目成员',
    'delete_user': '删除用户',
    'delete_work_log': '删除工作日志',
    'delete_risk': '删除风险',
    'delete_requirement_document': '删除需求文档',
    'delete_requirement_item': '删除需求条目',
    'delete_requirement_comment': '删除需求评论',
    'delete_requirement_link': '删除需求关联',
    'delete_knowledge_article': '删除知识文章',
    'delete_knowledge_category': '删除知识分类',
    'delete_knowledge_comment': '删除知识评论',
    'delete_personal_task': '删除个人任务',
    'delete_personal_template': '删除个人模板',
    'delete_personal_review': '删除个人复盘',
    'delete_test_suite': '删除测试套件',
    'delete_test_case': '删除测试用例',
    'delete_shift_schedule': '删除班次安排',
    'delete_user_shift': '移除用户班次',
    ...
    'move_requirement_item': '移动需求条目',
    'rollback_requirement_version': '回滚需求版本',
    'like_knowledge_article': '点赞知识文章',
    'favorite_knowledge_article': '收藏知识文章',
