...
- Bug跟踪管理
- 物料管理系统
- 合同管理系统（含站点、BOM、付款条款、IP等增强）
- 配送跟踪系统
- 考勤管理系统
- 需求管理
- 测试管理
- 用户与权限管理（角色 + 模块权限 + 权限模板）
- 知识库系统（v1.6 增强：状态流、置顶、收藏、导出、分享）
- 个人工作计划（v1.6 新增：四象限/日历/专注/习惯）
- 风险与问题管理（v1.6 新增：风险矩阵、敞口计算）
- 通知系统
- 统计报表
- 系统监控
- 审计日志
...
| PersonalPlan.vue | 个人工作计划（v1.6 新增） |
| RiskList.vue | 风险与问题管理（v1.6 新增） |
| Login.vue | 登录 |
